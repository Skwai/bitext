<template>
  <header class="AppHeader">
    ...
    <h1 class="AppHeader__Title">Bitcoin SMS Alerts</h1>
    <h2 class="AppHeader__Description">Enter your mobile number and get a one-time SMS notification when Bitcoin reaches a desired price</h2>
  </header>
</template>
